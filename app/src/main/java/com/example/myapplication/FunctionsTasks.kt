...
/**
 * Задание 1: Создайте функцию com.example.myapplication.maxOfTwo, которая принимает два числа в качестве аргументов
...
fun functionsTask1() {
    println( // вызов функции com.example.myapplication.maxOfTwo, параметрами которой являются результаты двух других вызовов
        maxOfTwo(
...
/**
 * Задание 2: Создайте функцию com.example.myapplication.sayHello, которая принимает строковый аргумент name и
...
/**
 * Задание 3: Создайте инфиксную функцию com.example.myapplication.isGreater , которая принимает два числа и возвращает true,
...
/**
 *
 *  Задание 4: Создайте рекурсивную функцию com.example.myapplication.generateSequence,
